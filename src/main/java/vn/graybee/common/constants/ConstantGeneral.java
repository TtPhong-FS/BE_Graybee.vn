...
public class ConstantGeneral {
    ...
    public static final String record_not_exists = "Không tìm thấy bản ghi. Vui lòng thử lại!";

    public static final String success_fetch_all = "Danh sách dữ liệu đã được lấy thành công!";

    public static final String success_update_status = "Cập nhật trạng thái thành công";

    public static final String empty_list = "Hiện tại chưa có dữ liệu nào. Hãy thử lại sau!";

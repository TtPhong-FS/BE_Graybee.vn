...
public interface AddressRepository extends JpaRepository<Address, Integer> {
    ...
    @Query("Select new vn.graybee.account.dto.response.AddressResponse(a) from Address a where a.customerId = :customerId")
    ...
    @Query("Select new vn.graybee.account.dto.response.AddressResponse(a) from Address a where a.id = :id and a.customerId = :customerId and a.isDefault = true")

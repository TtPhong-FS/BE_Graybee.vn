...
public class RamDetail {
    ...
    public RamDetail(Product product, String ramType, String series, int capacity, String type, int speed, String latency, float voltage, boolean ecc, boolean heatDissipation, String led) {

...
import vn.graybee.taxonomy.category.model.CategoryClassification;
import vn.graybee.taxonomy.category.repository.CategoryClassificationRepository;
...
@Service
public class CategoryClassificationImp implements CategoryClassificationService {
    ...
    public void createCategoryClassification(Integer categoryId, List<Integer> subcategoryIds, List<Integer> manufacturerIds) {
        ...
        for (int i = 0; i < maxLength; i++) {
            ...
            cf.setStatus(TaxonomyStatus.ACTIVE);

...
public class ConstantInventory {

    public static final String success_update = "Cập nhật số lượng sản phẩm thành công";

    public static final String success_delete = "Xoá sản phẩm khỏi kho thành công";
